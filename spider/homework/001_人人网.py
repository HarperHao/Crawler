...
url = 'http://www.renren.com/ajaxLogin/login?1=1&uniqueTimestamp=202093172858'
res = session.post(headers=headers, data=data, url=url)
print(res.text)
res = session.get(url='http://www.renren.com/974245919/profile', headers=headers)
